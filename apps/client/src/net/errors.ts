...
const MESSAGES: Readonly<Record<string, string>> = {
  ...
  DECOR_BLOCKS_PATH: 'That would close off part of your farm. Leave a way through.',
  DECOR_BLOCKS_PLOT: 'Too close to a crop — you would not be able to reach it.',
  DECOR_RESERVED_GROUND: 'Nothing can go there.',
  FURNITURE_BLOCKS_ROOM: 'That would box something in. Leave a way around it.',
  PLOT_EMPTY: 'There is nothing growing there.',
  PLOT_LOCKED: 'That plot is not cleared yet.',
  SEED_LOCKED: 'Your farm is not experienced enough for that seed yet.',
  INSUFFICIENT_ENERGY: 'You are too tired. Sleep in your bed to recover.',
  ASLEEP: 'You are asleep.',
  MILESTONE_NOT_EARNED: 'You have not earned that goal yet.',
  MILESTONE_ALREADY_CLAIMED: 'You have already claimed that goal.',
  QUEST_NOT_AVAILABLE: 'Your farm is not experienced enough for that request yet.',
  QUEST_ALREADY_ACCEPTED: 'You have already taken that on.',
  QUEST_NOT_ACCEPTED: 'You have not taken that on yet.',
  QUEST_ALREADY_COMPLETED: 'You have already handed that in.',
  LINE_ALREADY_OUT: 'Your line is already in the water.',
  NO_LINE_OUT: 'You have no line in the water.',
  CAST_EXPIRED: 'That cast is long gone. Try another.',
  ...
  TREE_NOT_READY: 'That tree is still growing back.',
  TOOL_REQUIRED: 'You need the right tool for that.',
